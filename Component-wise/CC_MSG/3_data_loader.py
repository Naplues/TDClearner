...
class Data_Loader(object):
    ...
    def make_dataloader(self):
        '''
        '''
        # make the train_dataloader, only keep msg and todo information  
        train_data = TensorDataset(\
                                    self.train_cc[0], self.train_cc[1], self.train_cc[2],\
        ...
        # make the test_dataloader, only keep msg and todo information  
        test_data = TensorDataset(\
                                    self.test_cc[0], self.test_cc[1], self.test_cc[2],\
